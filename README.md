# 📈 Alpha 阿爾法投資 — 政策驅動台美股投資研究與 StockAI 平台 (v2.0 最終定案版)

> **小白也一眼就懂的投資指南網站 (翡翠墨綠香檳金奢華風格 v2.0)**  
> 結合全球景氣循環、美國政策事件、台美供應鏈關聯數據，並整合 StockAI 股市問答機器人（支援雙配色、雙排快捷選單、隱藏檔 Key 預載與 400 題完整解答庫）。
...
`https://35.229.146.232/api/stocks/{ticker}/daily/`。代理只接受固定格式的
